...
DROP PROCEDURE IF EXISTS PRECIOCOTIZACION_INSERTAR
DROP PROCEDURE IF EXISTS PRECIOCOTIZACION_MODIFICAR
DROP PROCEDURE IF EXISTS PRECIOCOTIZACION_ELIMINAR
DROP PROCEDURE IF EXISTS PRECIOCOTIZACION_LISTAR
DROP PROCEDURE IF EXISTS PRECIOCOTIZACION_OBTENER
...
CREATE PROCEDURE PRECIOCOTIZACION_ELIMINAR(
	IN _id_productocotizacion INT
)
BEGIN
...
CREATE PROCEDURE PRECIOCOTIZACION_LISTAR()
BEGIN
	SELECT * FROM productoCotizado;
END $

CREATE PROCEDURE PRECIOCOTIZACION_OBTENER(
	IN _id_productocotizacion INT
)
BEGIN
	SELECT * FROM productoCotizado 
