...
public class Entrega {
    ...
    private int dni_recibo;
    private TipoEntrega tipoEntrega;

    public Entrega() {
    }

    public Entrega(int id, OrdenVenta orden, Date fecha_entrega, String direccion, int dni, TipoEntrega tipoEntrega) {
        this.id = id;
        this.orden = orden;
    ...
    public int getDniRecibo() {
        return dni_recibo;
    }

    public void setDniRecibo(int dni) {
        this.dni_recibo = dni;
    }
