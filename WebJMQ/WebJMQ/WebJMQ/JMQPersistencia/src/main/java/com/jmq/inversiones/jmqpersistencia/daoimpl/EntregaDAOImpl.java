...
public class EntregaDAOImpl extends BaseDAOImpl<Entrega> implements EntregaDAO{
    ...
    protected void setInsertParameters(PreparedStatement ps, Entrega entity) throws SQLException {
        ...
        cs.setInt(5, entity.getDniRecibo());
    ...
    ps.setInt(2, entity.getOrden().getId());
    ps.setTimestamp(3, new Timestamp(entity.getFecha_entrega().getTime()));
    ps.setString(4, entity.getDireccion());
    ps.setInt(5, entity.getDniRecibo());
    ps.setString(6, entity.getTipoEntrega().name());
